# Prompt for synthetic-consent-001

Use the uploaded fixture JSON file as the only GTM container export input.

Fixture ID: `synthetic-consent-001`

Expected issue category: all-pages remarketing and Custom HTML risk without clear consent evidence; expected rule `GTM-CONSENT-001`.
