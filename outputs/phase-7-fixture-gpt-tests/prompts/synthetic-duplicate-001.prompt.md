# Prompt for synthetic-duplicate-001

Use the uploaded fixture JSON file as the only GTM container export input.

Fixture ID: `synthetic-duplicate-001`

Expected issue category: duplicate GA4 purchase tracking on the same trigger; expected rules `GTM-DUP-001` and `GTM-ECOM-001`.
