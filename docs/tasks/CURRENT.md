...
- Do not start Task 5.1 implementation unless it is explicitly requested as the active task.
- Do not create the Task 5.1 fixture suite, Task 5.2 golden outputs, or Task 5.3 manual evaluation rubric unless the active task explicitly requires them.
...
- Phase 4 is complete. Task 5.1 is the next recommended task.
