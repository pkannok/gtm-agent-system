...
Definition:
The project-controlled file tree that stores decisions, task briefs, contracts, and future workflow assets.

Project usage:
The repository is the system of record for project terminology, deliverable contracts, and task scope.

Not to be confused with:
A generated output package, a Custom GPT configuration, or a live GTM account.
...
Definition:
A proposed JSON artifact containing reviewable GTM container optimizations.

Project usage:
One artifact in the GTM Container Audit & Patch Package. It is a proposed artifact, not a publish-ready guarantee.
...
Definition:
A proposed file-based change package represented by the optimized container and change log.

Project usage:
The MLP patch is not a live GTM API mutation.
...
Project usage:
The user interface for the MLP.
...
Definition:
A reusable workflow package made of instructions and supporting files.

Project usage:
The future portable workflow package for GTM container audit behavior, referencing repo-defined contracts.
